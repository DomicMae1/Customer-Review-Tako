...
import { BankSupplier } from '@/types';
import { ColumnDef } from '@tanstack/react-table';

export const bankSupplierColumns: ColumnDef<BankSupplier>[] = [
    {
    ...
    },
    {
        ...
        cell: ({ row }) => (
            <div className="text-sm md:min-w-[130px] md:truncate md:px-2 capitalize">{row.original.supplier_category}</div>
        ),
    },
    {
