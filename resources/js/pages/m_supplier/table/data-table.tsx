...
export function DataTable<TData, TValue>({ columns, data }: DataTableProps<TData, TValue>) {
    ...
    const [filterColumn, setFilterColumn] = useState<'nama_supplier' | 'creator_name' | 'nama_perusahaan' | 'keterangan_status' | 'status'>(
        'creator_name',
    );
    ...
    const handleSubmitName = async () => {
        ...
        try {
            const res = await axios.post(route('supplier-links.store'), {
    ...
    const handleSubmitImportCsv = (event: React.FormEvent) => {
        ...
        router.post(route('supplier.import-csv'), formData, {
            ...
            onError: (errors) => {
                ...
                toast.error(typeof firstError === 'string' ? firstError : 'Gagal mengimpor data supplier dari CSV.');
            },
        });
    };
        ...
        <div>
            <div className="hidden items-center justify-between gap-4 pb-4 md:flex">
                <div className="flex flex-wrap items-center gap-2">
                    <Select value={filterColumn} onValueChange={(val) => setFilterColumn(val as any)}>
                        ...
                        <SelectContent>
                            <SelectItem value="nama_supplier">Nama Supplier</SelectItem>
                    ...
                    {hasPermission('supplier.approve.direktur') && (
                        <div>
                        ...
                        <Dialog>
                            ...
                            <DialogContent>
                                <DialogHeader>
                                    ...
                                    <DialogDescription>
                                        Apakah Anda ingin membagikan formulir ke supplier, atau isi sendiri di sini?
                                    </DialogDescription>
                                </DialogHeader>
                                <div className="flex flex-col gap-4 py-4">
                                    <Link href="/supplier/create?mode=manual">
            ...
            <div className="flex w-full flex-col gap-4 px-5 py-3 md:hidden">
                <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0 flex-1">
                        <h1 className="text-foreground text-xl leading-tight font-bold">Supplier Data</h1>
                        <p className="text-muted-foreground mt-1 max-w-[240px] text-sm leading-snug">Manage your supplier</p>
                    </div>
            ...
            >
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        <DialogTitle>Import Supplier from CSV</DialogTitle>
                        <DialogDescription>Pilih perusahaan tujuan dan unggah file CSV supplier.</DialogDescription>
                    </DialogHeader>
            ...
            <Dialog open={isNameDialogOpen} onOpenChange={setIsNameDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogTitle>Masukkan Nama Supplier</DialogTitle>
                ...
                <DialogContent className="max-h-[90dvh] w-[calc(100vw-32px)] max-w-[calc(100vw-32px)] overflow-hidden rounded-xl p-0 sm:max-w-xl md:max-w-2xl lg:max-w-3xl">
                    <div className="max-h-[90dvh] overflow-y-auto p-4 sm:p-6">
                        <DialogHeader className="space-y-2 text-left">
                            ...
                            <DialogDescription className="text-sm leading-relaxed">Salin link berikut dan kirimkan ke supplier.</DialogDescription>
                        </DialogHeader>
