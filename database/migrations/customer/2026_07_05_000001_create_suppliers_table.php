...
return new class extends Migration
{
    ...
    {
        Schema::connection('tako-customer')->create('suppliers', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('supplier_category'); // trucking, pelayaran/freight, agent, lain2
    ...
    {
        Schema::connection('tako-customer')->dropIfExists('suppliers');
    }
};
